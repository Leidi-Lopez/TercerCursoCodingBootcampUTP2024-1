...
function adivinarNumero() {
  const numeroAleatorio = generarNumeroAleatorio(0, 100);//genera un numero aleatorio entre 0 y 100 
  let intentos = 0;//el contador de intetos realizado

  while (true) { // bucle hasta adivinar el numero 
    const numeroUsuario = parseInt(prompt("Adivina el número (entre 0 y 100):"));
    ...
    if (isNaN(numeroUsuario)) {
      ...
      console.log("El número debe estar entre 0 y 100.");//verifica si la entrada esta fuera del rango
...
function calcularFactorialFor(numero) {
  ...
  if (numero < 0 ) return "Ingrese un valor igual o mayor a 0";
  else {
